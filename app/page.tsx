...
export const metadata: Metadata = {
  title: 'AI Prompt Builder Pro - 专业垂直行业AI提示词生成器',
  description: '为律师、房产经纪人、保险顾问、教师、会计师等专业人士量身打造的智能AI提示词生成工具，提升工作效率，释放AI潜能',
  keywords: [
    'AI提示词生成器', 'ChatGPT提示词', 'Claude提示词', 
    '律师AI工具', '房产AI助手', '保险AI顾问', 
    '教师AI工具', '会计AI助手', '专业AI工具'
  ],
  openGraph: {
    title: 'AI Prompt Builder Pro - 专业垂直行业AI提示词生成器',
    description: '为专业人士量身打造的智能AI提示词生成工具',
